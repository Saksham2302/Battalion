 ...
 * @author chise
 */
public class Officers_Mess extends javax.swing.JFrame {
    ...
    private boolean viewByVR() {
        ...
        try {
            ...
            if (VR_panel.length() != 0) {
                String Query1 = "Select * from officers_mess_receipt where voucher='" + VR_panel + "' order by date, Voucher;";
                String Query2 = "Select * from Officers_mess_payment where voucher='" + VR_panel + "' order by date, voucher;";
                ResultSet rs = stmt.executeQuery(Query1);
                String voucher, date, type, Received_from, on_account, cash, bank, mess_fund, MMA, entertainment, Paper, silver, Momento, Wine, regt_cutting, M_S, sy_DR, sy_CR, fdr, property, offr_sports, offr_deposit;
                int sno = 0;
                ...
                while (rs.next()) {
                    ...
                    offr_deposit = rs.getString("offr_deposit");
                    offr_sports = rs.getString("offr_sports");
                    ...
                    fullscreen_table.addRow(new Object[]{
                        sno, VR_panel, date, "Receipt", Received_from, on_account, cash, bank, mess_fund, MMA, entertainment, Paper, silver, offr_sports, Momento, Wine, regt_cutting, M_S, offr_deposit, sy_DR, sy_CR, fdr, property
                    });
                }
                ...
                while (rs.next()) {
                    ...
                    fullscreen_table.addRow(new Object[]{
                        sno, VR_panel, date, "Payment", Received_from, on_account, cash, bank, mess_fund, MMA, entertainment, Paper, silver, offr_sports, Momento, Wine, regt_cutting, M_S, sy_DR, sy_CR, fdr, property
                    });
                }
            }
    ...
    private void viewall() {
        try {
            ...
            String Query1 = "Select * from Officers_mess_receipt order by date, Voucher;";
            String Query2 = "Select * from officers_mess_payment order by date, voucher;";
            ResultSet rs = stmt.executeQuery(Query1);
            String voucher, date, type, Received_from, on_account, cash, bank, mess_fund, MMA, entertainment, Paper, silver, Momento, Wine, regt_cutting, M_S, sy_DR, sy_CR, fdr, property, offr_deposit, offr_sports;
            int sno = 0;
            model_table.setRowCount(0);
            fullscreen_table.setRowCount(0);
            while (rs.next()) {
                ...
                fullscreen_table.addRow(new Object[]{
                    sno, voucher, date, "Receipt", Received_from, on_account, cash, bank, mess_fund, MMA, entertainment, Paper, silver, offr_sports, Momento, Wine, regt_cutting, M_S, offr_deposit, sy_DR, sy_CR, fdr, property
                });
            }
            rs = stmt.executeQuery(Query2);
            while (rs.next()) {
                ...
                fullscreen_table.addRow(new Object[]{
                    sno, voucher, date, "Payment", Received_from, on_account, cash, bank, mess_fund, MMA, entertainment, Paper, silver, offr_sports, Momento, Wine, regt_cutting, M_S, offr_deposit, sy_DR, sy_CR, fdr, property
                });
            }
    ...
    private void initComponents() {
        ...
        sports_textfieldA = new javax.swing.JTextField();
        ...
        offr_deposit_textfieldA = new javax.swing.JTextField();
        FDR_labelA = new javax.swing.JLabel();
        FDR_textfieldA = new javax.swing.JTextField();
        offr_deposit_labelA = new javax.swing.JLabel();
        underlineA22 = new javax.swing.JSeparator();
        underlineA23 = new javax.swing.JSeparator();
        ...
        side_pane.add(title_icon, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 115, 60, 60));

        title_label.setFont(new java.awt.Font("Montserrat", 0, 28)); // NOI18N
        title_label.setForeground(new java.awt.Color(255, 255, 255));
        title_label.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        title_label.setText("Offr Mess");
        side_pane.add(title_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 140, 40));
        ...
        panelA.add(panelA_bottom_line, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 1480, 910, -1));
        ...
        security_labelA.setText("Offrs Sports");
        ...
        sports_textfieldA.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        sports_textfieldA.setForeground(new java.awt.Color(54, 33, 89));
        sports_textfieldA.setBorder(null);
        sports_textfieldA.setMargin(new java.awt.Insets(2, 4, 2, 2));
        sports_textfieldA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sports_textfieldAActionPerformed(evt);
            }
        });
        panelA.add(sports_textfieldA, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 710, 320, 40));
        ...
        panelA.add(sy_CR_labelA, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 1110, -1, 40));
        ...
        panelA.add(sy_DD_labelA, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1110, -1, 40));
        ...
        panelA.add(sy_DR_textfieldA, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1150, 320, 40));
        ...
        panelA.add(sy_CR_textfieldA, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 1150, 320, 40));
        ...
        panelA.add(property_textfieldA, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1260, 320, 40));
        ...
        panelA.add(property_labelA, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1220, -1, 40));
        ...
        panelA.add(underlineA17, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1190, 320, 20));

        underlineA18.setForeground(new java.awt.Color(54, 33, 89));
        panelA.add(underlineA18, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1300, 320, 20));

        underlineA19.setForeground(new java.awt.Color(54, 33, 89));
        panelA.add(underlineA19, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 1190, 320, 20));
        ...
        offr_deposit_textfieldA.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        offr_deposit_textfieldA.setForeground(new java.awt.Color(54, 33, 89));
        offr_deposit_textfieldA.setBorder(null);
        offr_deposit_textfieldA.setMargin(new java.awt.Insets(2, 4, 2, 2));
        offr_deposit_textfieldA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                offr_deposit_textfieldAActionPerformed(evt);
            }
        });
        panelA.add(offr_deposit_textfieldA, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1040, 320, 40));
        ...
        panelA.add(FDR_labelA, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 1000, -1, 40));
        ...
        panelA.add(FDR_textfieldA, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 1040, 320, 40));

        offr_deposit_labelA.setBackground(new java.awt.Color(255, 255, 255));
        offr_deposit_labelA.setFont(new java.awt.Font("Montserrat", 0, 28)); // NOI18N
        offr_deposit_labelA.setForeground(new java.awt.Color(66, 50, 77));
        offr_deposit_labelA.setText("Offr Deposit");
        panelA.add(offr_deposit_labelA, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1000, -1, 40));

        underlineA22.setForeground(new java.awt.Color(54, 33, 89));
        panelA.add(underlineA22, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1080, 320, 20));

        underlineA23.setForeground(new java.awt.Color(54, 33, 89));
        panelA.add(underlineA23, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 1080, 320, 20));
        ...
        panelA.add(initials_labelA, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 1390, -1, 40));
        ...
        panelA.add(textArea_scrollpane, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 1340, 320, -1));
        ...
        fullscreen_tableB.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S. No.", "VR", "Date", "Received from", "On account", "Cash", "Bank", "Mess Fund", "MMA", "Entertainment", "Paper", "Silver", "JCO Securty", "Momento", "Wine", "Regt Cutting", "M&S", "Officers Deposit", "Officers sports", "Sy DR", "Sy CR", "FDR", "Property"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        if (fullscreen_tableB.getColumnModel().getColumnCount() > 0) {
            ...
            fullscreen_tableB.getColumnModel().getColumn(21).setMinWidth(150);
            fullscreen_tableB.getColumnModel().getColumn(21).setPreferredWidth(150);
            fullscreen_tableB.getColumnModel().getColumn(21).setMaxWidth(150);
            fullscreen_tableB.getColumnModel().getColumn(22).setMinWidth(150);
            fullscreen_tableB.getColumnModel().getColumn(22).setPreferredWidth(150);
            fullscreen_tableB.getColumnModel().getColumn(22).setMaxWidth(150);
        }
    ...
    private void sports_textfieldAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sports_textfieldAActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sports_textfieldAActionPerformed
            ...
            if (!date.equals("")) {
                try {
                    ...
                    if (receipt_radio.isSelected()) {
                        pstmt = con.prepareStatement("Insert into officers_mess_receipt values( ?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");

                        flag = true;
                    } //Add one more ? for offr_sports later in pstmt!!
                    else if (payment_radio.isSelected()) {
                        pstmt = con.prepareStatement("Insert into Officers_mess_payment values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
                        flag = true;
                    } else {
                    ...
                    if (flag) {
                        ...
                        pstmt.setString(12, momento_textfieldA.getText().trim());
                        pstmt.setString(13, wine_textfieldA.getText().trim());
                        pstmt.setString(14, regt_textfieldA.getText().trim());
                        pstmt.setString(15, MS_textfieldA.getText().trim());
                        pstmt.setString(16, sports_textfieldA.getText().trim());
                        pstmt.setString(17, offr_deposit_textfieldA.getText().trim());
                        pstmt.setString(18, sy_DR_textfieldA.getText().trim());
                        pstmt.setString(19, sy_CR_textfieldA.getText().trim());
                        pstmt.setString(20, FDR_textfieldA.getText().trim());
                        pstmt.setString(21, property_textfieldA.getText().trim());
                        pstmt.executeUpdate();
    ...
    private void print_buttonBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_print_buttonBMouseClicked
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select * from officers_mess_receipt");
            ...
            cell.setCellValue("Officer sports");
            ...
            cell.setCellValue("officer deposit");
            ...
            while (resultSet.next()) {
                ...
                cell = row.createCell(11);
                cell.setCellValue(resultSet.getString("offr_sports"));
                cell = row.createCell(12);
            ...
            resultSet = statement.executeQuery("select * from officers_mess_payment");
            ...
            FileOutputStream out = new FileOutputStream(new File(paths.csv + "\\Officers_Mess.xlsx"));
            workbook.write(out);
            JOptionPane.showMessageDialog(null, "Officer_Mess written successfully!", "Successful", JOptionPane.WARNING_MESSAGE);
            Desktop.getDesktop().open(new File(paths.csv + "/Officers_Mess.xlsx"));
    ...
    private void offr_deposit_textfieldAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_offr_deposit_textfieldAActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_offr_deposit_textfieldAActionPerformed
    ...
    private void reset_buttonAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_reset_buttonAMouseClicked
        ...
        offr_deposit_textfieldA.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Officers_Mess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel offr_deposit_labelA;
    private javax.swing.JTextField offr_deposit_textfieldA;
    ...
    private javax.swing.JTextField sports_textfieldA;
    ...
    private javax.swing.JSeparator underlineA23;
