 ...
 * @author chise
 */
public class URCC extends javax.swing.JFrame {

    /**
     * Creates new form URCC
     */
    ...
    private void initComponents() {
        ...
        side_pane.add(title_icon, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 115, 80, 60));

        title_label.setFont(new java.awt.Font("Montserrat", 0, 28)); // NOI18N
        title_label.setForeground(new java.awt.Color(255, 255, 255));
        title_label.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        title_label.setText("URCC");
        side_pane.add(title_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 132, 100, 30));
        ...
        if (fullscreen_tableB.getColumnModel().getColumnCount() > 0) {
            fullscreen_tableB.getColumnModel().getColumn(0).setMinWidth(150);
            fullscreen_tableB.getColumnModel().getColumn(0).setPreferredWidth(150);
            fullscreen_tableB.getColumnModel().getColumn(0).setMaxWidth(150);
    ...
    private void menuBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuBMouseClicked
        ...
        try{
            ...
            String query ="select *from urcc_rec";
            ...
            String query2 ="select *from urcc_pay";
    ...
    private void okayBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_okayBMouseClicked
        ...
        if(vrr==null || vrr.trim().isEmpty()){
            ...
            try{
                Statement st = con.createStatement();
                ResultSet rs = null;
                String q1="select count(*) as count from urcc_rec where VR='"+vrr+"'";
                String q2="select count(*) as count from urcc_pay where VR='"+vrr+"'";
                ...
                if(checker==1 ||checker==2){
                    ...
                    String type="";
                    if(checker==1){
                        q="select *from urcc_rec where VR='"+vrr+"'";
                        type="Receipt";
                    }    
                    if(checker==2){
                        q="select *from urcc_pay where VR='"+vrr+"'";
                        type="Payment";
                    }
    ...
    private void insert_buttonAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_insert_buttonAMouseClicked
        ...
        try{
            ...
            if(check_all_tf && check_all_dd &&(button_check==1 || button_check==2)) {
                if(button_check==1){
                    query = "insert into urcc_rec " + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                }
                else
                    query = "insert into urcc_pay " + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private void print_buttonBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_print_buttonBMouseClicked
        ...
        Statement statement =con.createStatement();
            ResultSet resultSet = statement.executeQuery("select * from urcc_rec");
            ...
            resultSet = statement.executeQuery("select * from urcc_pay");
            ...
            FileOutputStream out = new FileOutputStream(new File(paths.csv + "\\" +"URCC.xlsx"));
            workbook.write(out);
            //System.out.println("csd.xlsx written successfully");
            JOptionPane.showMessageDialog(null,"URCC.xlsx written successfully");
            Desktop.getDesktop().open(new File(paths.csv + "/URCC.xlsx"));
        } catch (Exception  e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URCC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
